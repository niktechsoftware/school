...
<div class="alert alert-info">	<h3 class="media-heading text-center">Welcome to Transfer Certificate</h3>
<p class="media-timestamp">If you want to give Transfer Certificate to your Student, then go to Student ID box and click Get Certificate 
button then generate Student Transfer Certificate.</p>
</div>
