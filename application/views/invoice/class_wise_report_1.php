...
$cumulativetotal=0;
       ...
       $pi=1;
		...
		<tr class="wight">
					...
					if($h<5){?>
					<td >
				<b><?php echo $ctotal[$i];  ?></b>	
					</td>
					<?php if($h%2==0){ ?>
					<td class="bold"><?php $cumulativetotal+=$ctotal['tot'.$h];echo $ctotal['tot'.$h];?> </td> 
					<td class="bold"></td>
					<?php 			} ?>
					<?php $h++; $i++; } endforeach;	
					?>
			<td class="bold"><?php echo $cumulativetotal;?></td>
			<td class="bold"></td>
		</tr>
		<tr class="tableHeader">	
 ...
 if(is_numeric($exammm)){
   ...
   <!---2nd term exam name start--->
		...
		<tr class="wight"> 
			   ...
			   <td class="center bold"><?php $colmtot = $colmtot+ $gtptal+$gtptal_2;echo calculateGrade($rty,$classid)?></td>		
		</tr>
					<?php } }endforeach;?>
		<tr class="wight">
					<td class="subject">GRAND TOTAL</td>
...
if(is_numeric($exammm)){
     echo "/".$exammm;
				...
				<td><?php if($gtptal>0){echo $gtptal;?>/<?php echo $ttal;}?></td>
					<td><?php if($gtptal>0){echo calculateGrade($gtptal*2,$classid);}?></td>
				<!--1st term marks end-->
				<!--2nd term marks start-->
				 <?php 
                 $gtptal_2=0;
 ...
 if(is_numeric($exammm)){
      echo "/".$exammm;
				...
				<td><?php if($gtptal_2 >0){ echo calculateGrade($gtptal_2*2,$classid);}?></td>
				...
				<td><?php if($gtptal+$gtptal_2>0){ echo calculateGrade($gtptal+$gtptal_2,$classid);}?></td>
		...
		<tr class="wight">
					...
					<td colspan="3"><?php echo discriptiveindicator($cumulativetotal);?></td>
						<td><?php echo calculateGrade1($marks->marks,$classid)?></td>
														...
														<?php }else{?>
					<td colspan="3"><?php echo discriptiveindicator($cumulativetotal);?></td>
						<td><?php echo calculateGrade1(0,$classid)?></td>
					<?php	} 
			...
			<td colspan="9" style="text-transform: uppercase;">	<?php echo $this->exammodel->getClassRank($studentInfo->id, $classid, $fsd); ?></td>
		</tr>
