                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th colspan="4">Periodic Test</th>
                            <th rowspan="2">NoteBook(5) &
                                Sub. Enrichment(5)<br>
                                <span>(B=10)</span></th>
                                <th  rowspan="2">Total<br>(A+B=20)</th>
                                <th rowspan="2">Annual Exam<br>(C=80)</th>
                                <th rowspan="2">Grand Total<br>(A+B+C=100)</th>
                       ...
                       <tr>
                            ...
                            <th>PT2<br>(10)</th>
                             <th >PT3<br>(10)</th>
                             <th>Avg Of best 2 PT<br>(A=10)</th>
                      </tr>
                    </thead>
                    <tbody>
                        <?php $i=1;?>
			...
			<div>
                <table
                    ...
                    <tr><?php
							...
							$this->db->where("fsd",$this->session->userdata('fsd'));
							$this->db->where("stu_id",$studentInfo->id);
						echo	$t1 = $this->db->get("exam_info")->num_rows();
							$this->db->where("school_code",$this->session->userdata("school_code"));
							$this->db->where("term", 2);
							$this->db->where("fsd",$this->session->userdata('fsd'));
							$this->db->where("stu_id",$studentInfo->id);
							$t2 = $this->db->get("exam_info")->num_rows();*/
...
<?php } ?>
            ...
            <br />
            <div>
            <p><h3 style="color: white;text-transform: uppercase;">Instructions</h3></p>
