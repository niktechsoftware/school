...
<table>
    <thead>
        <th><img src="<?php echo $this->config->item('asset_url'); ?><?php echo $this->session->userdata("school_code");?>/images/empImage/<?php echo $info->logo;?>" alt="" width="180" height="140" /></th>
        <th style="align:center;margin-left:20%;"><h2 align="center" style="text-transform:uppercase;"><b><?php echo $info->school_name; ?></b></h2>
        <h4 align="center" style="font-variant:small-caps;padding:10px;">
        	<?php echo $info->address1." ".$info->address2." ".$info->city; ?>
        </h4>
        <h4 align="center" style="font-variant:small-caps;padding-bottom:10px;">
...
?>
    <div class="row">      
    <div class="col-md-2"></div>
	<div class="col-md-7"><span style="font-size:20px;letter-spacing: 2px;border-radius: 25px;border: 2px solid #002D65;font-family:arial; padding: 10px; width: 250px; color:white; background-color:#002D65;margin-left:15%;"><b>TRANSFER CERTIFICATE</b></span></div>
	...
	<div class="tcbody">
	 ...
	 <table>
	     <tr>
	        <td>
            <div class="" style="padding-top:8px; padding-bottom:8px;"><span style="color:#002D65; font-size:14px;">विद्यालय संख्या /School No : 
        	...
        	<td>
        	<span style="color:#002D65; font-size:14px;">Affiliation No : 
            <strong style="color:black;">
    ...
    <div class="row">  
     <table>
        <tr>
            <td>
                <span style="color:#002D65; font-size:14px;">पुस्तक संख्या /  Book No :</td><td> <strong style="color:black;"><?php echo $rowb->book_no;?> </strong></span>
            </td>
            <td>
            ...
            <td>
                <div class="" style="padding-top:8px; padding-bottom:8px;"><span style="color:#002D65; font-size:14px;">क्रम संख्या /  S.No. : </td><td><strong style="color:black;"><?php echo $rowb->sno;?> </strong></span></div>
		    </td>
		    <td>
            <div class="" style="padding-top:8px; padding-bottom:8px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
		    ...
		    <td>
		        <div class=" " style="padding-top:8px; padding-bottom:8px;"><span style="color:#002D65; font-size:14px;">प्रवेश संख्या / Admission No : </td><td><strong style="color:black;"><?php echo $rowb->scholer_no;?> </strong></span></div>
            </td>
        </tr>
   </table>
    </div>
	...
	<strong style="color:black;text-transform:uppercase;"><input type="text" value="<?php if(strlen($tccerti->registration_no)>1){echo $tccerti->registration_no;}else{ echo "N/A";};?>" id="registration_no" class="renewed text-uppercase disable"/></strong></div>
    </div>
    </div>
		    
	<div class="tcbody" style="color:#002D65;">
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">1.  विद्यार्थी का नाम/  Name of Pupil : <strong style="color:black;text-transform:uppercase;"><?php echo $stuname; ?></strong></div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">2. पिता का नाम / Father's Name : <strong style="color:black;text-transform:uppercase;"><?php echo $fname;?></strong></div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;" >3. माता का नाम / Mother's Name : <strong style="color:black;text-transform:uppercase;"><?php echo $mname;?></strong></div>
	
	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">4. राष्ट्रीयता/ Nationality :<strong style="color:black; text-transform:uppercase">Indian </strong> </div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">5. क्या अनु . जाति  / जन. जा. /  पिछड़ा वर्ग से संबंधित है: Whether the pupil belongs to SC/ST/OBC Category :<strong style="color:black; text-transform:uppercase"><?php echo $rowb->category;?> </strong> </div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">6. प्रवेश पुस्तिका के अनुसार जन्म तिथि / Date of Birth according to the Admission Register :(अंको में / in figure)
<strong style="color:black; text-transform:uppercase"><br />&nbsp;&nbsp;&nbsp;<?php echo $rowb->dob;?> </strong>(शब्दों में / in words ) </div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">7.क्या विद्यार्थी का परीक्षा परिणाम अनुतीर्ण है /  Whether the student is failed : <strong style="color:black;text-transform:uppercase;"><input type="text" value="<?php if(strlen($tccerti->student_status)>1){echo $tccerti->student_status;}else{ echo "N/A";};?>" id="status" class="renewed text-uppercase disable"/></strong></div>

	</div>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">8.  प्रस्तावित विषय/  Subject Offered : <strong style="color:black;text-transform:uppercase;"><input type="text"style='width:950px;' value="<?php if(strlen($tccerti->subject_offered)>1){echo $tccerti->subject_offered;}else{ echo "&nbsp;&nbsp;&nbsp; N/A";};?>" id="subjectid" class="renewed text-uppercase disable"/></strong></div>
...
// 	$i++; };
	...
	?>
	<div class="row">
	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">9. पिछली कक्षा  जिसमे विद्यार्थी अध्यनरत था : (अंको में )Class in which the pupil last studied(in words) :<strong style="color:black; text-transform:uppercase"> <?php echo $class;?></strong></div>
   ...
   <?php echo $tccerti->padonnati;?>
    ...
    <div class="row">
    	<div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">12.क्या विद्यार्थी ने विद्यालय की सभी देय राशि का भुगतान कर दिया है : Whether the pupil has paid all dues to 
    	the vidyalaya:YES
    	</div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">13.क्या विद्यार्थी को कोई शुल्क रियायत प्रदान की गयी थी , यदि हाँ , तो उसकी प्रकृति : Whether the pupil was in reciept of any 
	    fee &nbsp;&nbsp;&nbsp;&nbsp;concession,if so the nature of the such concession : <strong style="color:black;text-transform:uppercase;"><input type="text" value="<?php if(strlen($tccerti->any_fee_concession)>1){echo $tccerti->any_fee_concession;}else{ echo "N/A";};?>" id="concession" class="renewed text-uppercase disable"/></strong></div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:12px;">14.क्या विद्यार्थी  एन.सी.सी कैडेट / स्कॉउट के विवरण दे : Whether the pupil is NCC Cadet,Boy/Girl Scout (give details) : <strong style="color:black;text-transform:uppercase;"><input type="text"  size="8" value="<?php if(strlen($tccerti->ncc_cadet)>1){echo $tccerti->ncc_cadet;}else{ echo "N/A";};?>" id="ncc_cadet" class="renewed text-uppercase disable"/></strong></div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">15. विद्यालय से विद्यार्थी के नाम काटे जाने की तिथि :Date of which pupil name was struck of the rolls of the school : <strong style="color:black;text-transform:uppercase;"><input type="text" size="8" value="<?php if($tccerti->joining_date){echo date("Y-m-d", strtotime($tccerti->joining_date));}else{ echo "N/A";};?>" id="addmission_date" class="renewed text-uppercase disable"/></strong></div>
	...
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">17.अंतिम तिथि तक उपस्थितियो की कुल संख्या / No. of meeting up to date : <strong style="color:black;text-transform:uppercase;"><input type="text" value="<?php if(strlen($tccerti->meeting_date)>1){echo $tccerti->meeting_date;}else{ echo "N/A";};?>" id="meeting_date" class="renewed text-uppercase disable"/></strong></div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">18. विद्यार्थी की विद्यालय दिवसों की कुल उपस्थितियॉ /No. of school days the pupil attended :<strong style="color:black;text-transform:uppercase;"><input type="text" value="<?php if(strlen($tccerti->pupil_attended_day)>1){echo $tccerti->pupil_attended_day;}else{ echo "N/A";};?>" id="attended_day" class="renewed text-uppercase disable"/></strong> </div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">19.सामान्य आचरण / General conduct :<strong style="color:black; text-transform:uppercase">Good </strong> </div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">20.विद्यालय का वर्ग सरकारी / माइनोरिटी / स्ववित्तपोषी के  अंतर्गत  Whether School is under Govt./Minority/Independent&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;category : <strong style="color:black; text-transform:uppercase">Independent </strong></div>

	</div>
	<div class="row">
	    <div class="col-md-14" style="padding-top:8px; padding-bottom:8px; font-size:13px;">21. कोई अन्य टिप्पणी /Any other remarks : <strong style="color:black;"><input type="text" value="<?php if(strlen($tccerti->other_remarks)>1){echo $tccerti->other_remarks;}else{ echo "N/A";};?>" id="other_remark" class="renewed text-uppercase disable"/></strong></div>
				...
				<tbody>
					<tr style="padding-top:8px; padding-bottom:8px; font-size:17px;">
						...
						<!--		(Name & Designation)-->
						  ...
						  <td valign="top" width="275"><div align="left">
								<strong>ह . प्रधानाचार्य/ कार्यालय  मोहर Sign. of Principal</strong><br><br>
							<!--	(Official Seal)-->
							</div></td>
					</tr>
				</tbody>
