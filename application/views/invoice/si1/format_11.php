		...
		<!--other size end-->
                ...
                <div style="width:95%; margin-left:auto; margin-right:auto; border:1px  solid yellow; height:auto; ">
                    ...
                    <table style="width: 100%;"> <tr >
						 ...
						 <tr class="wight" style="font-size: 12px;">
							<td 
                ...
                <table style="width:95%;font-size: 12px;">
					<tr style="height: 70px;">
                        ...
                        <td><label> Principal Signature:</label>
                            <div>
                                <img src="<?php echo $this->config->item('asset_url'); ?><?= $this->session->userdata('school_code') ?>/images/empImage/<?php echo $info->principle_sign;?>" alt="" width="70" height="50" style="margin-top=-60px;" />
    		                </div>
                        </td>
                    </tr>
                </table>
