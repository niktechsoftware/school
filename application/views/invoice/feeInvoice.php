...
for($nop=1;$nop <= $numberofReciept;$nop++ ){
	...
	<div id="page-wrap" style="border:1px solid #333; width: 100%; margin-top:10px;">
			...
			<tbody>
				<tr style="background-color:#a1d657" class='text-uppercase'>
					...
					<td style="border: none; text-align:center;">
						<span style="text-transform:uppercase; margin-top:0; margin-bottom:0; font-size:<?php echo $font+8;?>px;"><b><?php echo $info->school_name; ?></b></span><br>
		...
		<div id="customer" style="margin:5px;">
            ...
            <table> 
                    ...
                    <tr class='text-uppercase'>
                    	<td class="meta-head" style="padding:5px; font-size:<?php echo $font+1;?>px;">
						<strong>Father's Name</strong><td style="padding:5px; font-size:<?php echo $font;?>px;"> <?php echo $pInfo->father_full_name; ?></td>
                        </td>
                    </tr>
					<tr class='text-uppercase'>
					...
					?>
                    	<td class="meta-head" style="padding:5px; font-size:<?php echo $font+1;?>px;">
						<strong>Class & Sec. </strong><td style="padding:5px; font-size:<?php echo $font;?>px;"><?php echo $classname->class_name ;?> - <?php echo $section->section ;?> 
						</td></td>
                    </tr>
                    <tr class='text-uppercase'>
                    	<td class="meta-head" style="padding:5px; font-size:<?php echo $font+1;?>px;">
						<strong>  Address  </strong>	<td style="padding:5px; font-size:<?php echo $font;?>px;"><?php echo $rowc->address1.'<br> '.$rowc->city.' - '.$rowc->pin_code;	?></td>
						</td>
                    </tr>
                    </tbody>
			</table>
    ...
    <div style="display:inline-block; float:right; background-color:#e5952d">
            <table>
                <tbody>
				<tr class='text-uppercase'>
                    <td class="meta-head" style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"><b>Receipt No.</b></td>
                    <td style="padding: 0 5px 0 5px; font-size:<?php echo $font;?>px;"><?php echo $feeRecord->invoice_no; ?></td>
                </tr>
                <tr class='text-uppercase'>
                    <td class="meta-head" style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"> <b>Student ID </b></td>
                    <td style="padding: 0 5px 0 5px; font-size:<?php echo $font;?>px;" ><?php echo $rowc->username; $id = $rowc->id; ?></td>
                </tr>
                <tr class='text-uppercase'>
                    <td class="meta-head" style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"> <b> Mode </b></td>
				...
				?>
                <tr class='text-uppercase'>
                    <td class="meta-head"  style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"> <b>No. of Month </b></td>
                ...
                <tr class='text-uppercase'>
                    <td class="meta-head" style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"> <b>Deposit Date </b></td>
                    <td style="padding: 0 5px 0 5px; font-size:<?php echo $font;?>px;">
                    	<?php 
                ...
                <tr class='text-uppercase'>
                     <td class="meta-head" style="padding: 0 5px 0 5px; font-size:<?php echo $font+1;?>px;"> <b>Fee For  </b></td>
                   <td style="padding: 0 5px 0 5px; font-size:<?php echo $font;?>px;">
		...
		<table id="items" style="margin: 5px 0 0 0;">
		  <tbody style=" background-color:#ffff99">
		      <tr class='text-uppercase'>
		          	<td colspan="3" align="center" style="background-color:green; color:white;" ><b>Student Fee Details</b></td>
		      </tr>
		  <tr class='text-uppercase'>
		...
		<?php
				...
				<!--<hr style="margin-top:5px; margin-bottom:0;">-->
				  ...
				  <tr class='text-uppercase'>
				  	...
				  	<strong>   Received by :</strong><?php echo $info->school_name; ?> &nbsp <strong>Paid By :</strong> <?php echo $rowc->username;?><br>
				  	<strong>Paid Amount in Words : </strong><script> document.write(convert_number(<?php echo $feeRecord->paid; ?>)); </script> Only /-<br>
						This is computer generated invoice and verified by accountant.
				  
				  	</td>
				
				 	<td class="col-sm-2 text-center"  style="background-color:#caf441; font-size:<?php echo $font;?>px;" > <strong>Total</strong> </td>
			 		<td class="col-sm-3 text-center"  style="background-color:#caf441;"   ><?php echo sprintf('%0.2f',$feeRecord->total); ?> </td>
				  </tr>
				
				  <tr class='text-uppercase'>
				  	<td class="text-center text-nowrap"  style="background-color:#caf441; font-size:<?php echo $font;?>px;" > <strong>Amount Paid</strong></td>
				  	<td class="text-center" style="background-color:#caf441" ><?php echo $feeRecord->paid; ?></td>
				  </tr>
				  <tr class='text-uppercase'>
				  	<td class="text-center text-nowrap"  style="background-color:#caf441;font-size:10px; " ><strong>Balance Due</strong></td>
