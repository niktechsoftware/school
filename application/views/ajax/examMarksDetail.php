	  		...
	  		if($val->num_rows()>0){
                ...
                ?>
                  ...
                  <tr>
                    <td><?php echo $j; ?></td>
                    <td>
                        <input type="hidden" id="rowexam<?php echo $i; ?>" value="<?php echo $v->id; ?>" />
				  ...
				  $("#deletemmarks1<?php echo $i;?>").click(function(){
				       var row = $("rowexam<?php echo $i; ?>").val();
                           
							//alert(classid +" "+ subjectid +" "+examid);
                    $.post("<?php echo site_url("index.php/examControllers/deletesubMarks") ?>",{row : row}, function(data){
              ...
              $("#submit<?php echo $i;?>").click(function(){
                ...
                var attendence = $("input[name='attendence<?php echo $i; ?>']:checked").val();
    				   ...
    				   //alert(fsd);
    					...
    					$.post("<?php echo site_url("index.php/examControllers/insertMarksdetail") ?>",{fsd : fsd, examid:examid, attendence: attendence,stuid : stuid, marks : marks,mmarks:mmarks, fsd : fsd, sub_type:sub_type,classid:classid,subjectid:subjectid}, function(data){
