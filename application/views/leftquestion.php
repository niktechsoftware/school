...
When all questions are answered, then click on submit button.
                      ...
                      <div class="panel panel-calendar">
                        <div class="panel-heading panel-blue border-light">
                          <h4 class="panel-title" style="font-size:150%;">Left Quesion List:</h4>
                          <p id="demo" style="margin-left:80%; font-size:150%;"></p>
                        </div>
                        <div class="panel-body" id="list">
                            <?php $i=0; foreach($exam->result() as $row):
                              $this->db->where('exam_master_id',$row->exam_id);
                              $ques=$this->db->get('question_master')->row();
                              if($ques->id==$row->question_id){
                                  //echo "all done";
                              }else{?>
