...
<div class="row">
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover" id="sample-table-2">
			...
			if($n)
			{
				$r = $this->db->query("select * from notice where id= '$n' AND school_code='$school_code' ")->result();
				$count = 1;
							foreach($r as $lv): ?>
								<tr>
			...
			{
			$r = $this->db->query("select * from notice where school_code='$school_code' ")->result();
			    $count = 1;
			foreach($r as $lv): ?>
				<tr>
		  			<td><?php echo $count;?></td>
