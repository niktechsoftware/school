					...
					<div class="col-sm-12">
									...
									<div class="row">
										...
										<div class="panel  panel-calendar">
												...
												<div class="panel-body space10">
													<div class="row col-sm-12">
													    ...
													    <tr>
													    	...
													    	<td> <input type="text" name="examName" style="width: 180px;"  required="" onkeyup="myfunction1()" onkeyup="myfunction()" />
													    	<br><br></td>
													    </tr>
													    <tr>
													    	<td><label class="panel-title">Starting Date</label> 
													    	</td>
													    	<td><input  type="date" data-date-format="yyyy-mm-dd"   name ="datet" data-date-viewmode="years"  style="width: 180px;" class="date-picker" required=""> 
														<br><br>
													    	</td>
													    </tr>
											...
											<form action="<?php echo base_url();?>index.php/examControllers/updateData2"  method ="post"  id="form">
												<div class="panel-body space10">
													<div class="row col-sm-12">
													    <div class="space10" >
													    <table>
													    <tr>
													    	...
													    	<td>  <select class="form-control space10" id="examName1" name="examName" style="width: 160px;" >
														...
														<br></td></tr>
													    	<tr><td>
															<label class="panel-title">Enter Exam Name</label> </td>
								                     <td> <input  type="text" id="upexam" name ="upexam"  style="width:150px;height:35px;" placeholder="Enter Exam Name">
														</br></td></tr>
														</br>
													 <tr>
													    	...
													    	<td> <br/>
													    	<input  type="text" class="form-control space10"  id = "printDate1" name="datet"  style="width: 160px;"  placeholder="Exam Date" > 
													    Enter Date If you want to change	<input  type="date" class="form-control space10"  id = "printDate" name ="datet"  style="width: 160px;"  placeholder="Enter Date"> 
