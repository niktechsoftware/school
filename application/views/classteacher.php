	...
	<div class="col-md-12">
		...
		<div class="panel panel-white">
			<div class="panel-heading panel-green">
				<h4 class="panel-title">Class Teacher <span class="text-bold"> Report</span></h4>
...
<h4 class="media-heading text-center">Welcome to Class Wise List Area</h4>
<p>
Here you can see all class teacher, and also you can see all class students on click total student.
</p> 
</div>
<div class="row">
...
<td>
<a href="<?php echo base_url();?>index.php/login/findclassstudent/<?php echo $id;?>"><?php echo $class_id->num_rows(); ?></a>
</td>
</tr>
<?php
$sno++;
