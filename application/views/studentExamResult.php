           ...
           <div class="col-md-4">
            <select id="fsda" class="form-control">
                <option value="">Select FSD</option><?php
                  ...
                  $query= $this->db->query("SELECT exam_max_subject.fsd as fsd from exam_max_subject  join  exam_name  on exam_name.id=exam_max_subject.exam_id  where exam_name.school_code='$school_code'");
                    if($query->num_rows()>0){
