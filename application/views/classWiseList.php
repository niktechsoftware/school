			...
			<div class="panel-body">
				<div class="form-group">
					...
					$school_code =$this->session->userdata("school_code");
						$detail = $this->db->query("SELECT finance_start_date FROM `fee_deposit` where school_code='$school_code' GROUP BY finance_start_date");
					...
					<div class="col-sm-2">
						<select class="form-control" id="classv" name="class" style="width: 150px;" required="required">
