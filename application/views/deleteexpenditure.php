            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    ...
                    <div class="alert alert-info">
                        <h3 class="media-heading text-center">Welcome to Delete Expenditure Detail</h3>
                        <p class="media-timestamp"> Here you can Delete Expenditurexam Detail.For Deletion Expenditure Detail Admin mobile number is required.after filling the Admin
                        mobile number a OTP send to mobile number when OTP Matched then Admin Delete Expenditure.</p>
                    </div>
                    <div id="msg"></div>
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading panel-red border-light">
                                <h4 class="panel-title">Expenditure Name</h4>
                            </div>
                            <div class="panel-body">
                                ...
                                <input type="hidden" class="form-control" id="exp_id" name="exp_id" value="<?php echo $expid?>" >
                                    <br><br>
                             ...
                             <button type="submit" id="conform" class="btn btn-red" >
                                            Delete Expenditure Detail<i class="fa fa-report" ></i>
                                        </button> 
                            </div> 
                           </div>
                                 </div>
