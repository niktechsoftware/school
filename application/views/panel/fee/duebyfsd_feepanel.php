				...
				<div class="form-group">
	             ...
	             <label class="col-sm-1 control-label">
					...
					<div class="col-sm-2"  >
						...
						$oneback =date('Y-m-d', strtotime("-1 months", strtotime($cdate)));
						$twoback =date('Y-m-d', strtotime("-2 months", strtotime($cdate)));
						?>
						    <option>--Select--</option>
						    
						   <option value="<?php echo date("m",strtotime($cdate));?>"><?php echo date("M-Y",strtotime($cdate));?></option>
