<div class="row">
  <div class="col-md-12">
    ...
    <div class="panel panel-white">
      <div class="panel-heading panel-red">
        <h4 class="panel-title">Teacherwise <span class="text-bold">HomeWork Report</span></h4>
  ...
  <div class="panel-body">
       <div class="text-white text-large">
        <div class="col-sm-4">
<select id="teachertimetable" class="form-control">
                            ...
                            foreach($emp as $data)
                            {
                              ...
                              <option value="<?php echo $data->username;?>"><?php echo $data->name;?>&nbsp;&nbsp;(<?php echo $data->username;?>)</option>
                              <?php
                             } ?>
                            </select>
</div>
				 ...
				 <div class="col-sm-12">
                      <div class="panel panel-calendar">
                        <div class="panel-heading panel-blue border-light">
                          <h4 class="panel-title">Teacherwise HomeWork list</h4>
                        </div>
