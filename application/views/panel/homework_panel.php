  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-white">
      <div class="panel-heading panel-purple">
        <h4 class="panel-title">Welcome to <span class="text-bold">Home Work Panel</span></h4>
          ...
          <a class="btn btn-xs btn-link panel-close" href="#">
            <i class="fa fa-times"></i>
									...
									<div class="panel-body">
										...
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/studentwisehomeworkpanel">
										...
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/classwisehomeworkpanel">
										...
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/teacherwisehomeworkpanel">
												<button class="btn panel-purple btn-icon btn-block space10">

												<font size="5">Teacher Wise</font><span class="badge badge-info partition-purple"> 3 </span>
												</button>
												</a>
											</div>

										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/topperfstdhomeworkpanel">
												<button class="btn panel-red btn-icon btn-block space10">

												<font size="5">	Top 10 student  <br>Perform Home Work  </font><span class="badge badge-info partition-black"> 4 </span>
												</button>
												</a>
											</div>
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/toplosstdhomeworkpanel">
												<button class="btn panel-azure btn-icon btn-block space10">

													<font size="5">Top 10 Loss Perform <br>Student </font><span class="badge badge-info partition-blue"> 5 </span>
												</button>
												</a>
											</div>
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/homeworkpanel/homestatushomeworkpanel">
												<button class="btn panel-orange btn-icon btn-block space10">

													<font size="5">Student Homework <br> Status </font><span class="badge badge-info partition-red"> 6 </span>
												</button>
												</a>
											</div>
