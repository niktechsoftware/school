					...
					<tbody>
						<?php 
					 	$data=array(); $i=1; $j=0;
								...
								$this->db->where('job_title','employee');		
							...
							if($emp->num_rows()>0){
								...
								foreach($empp as $employee):
											...
											<tr>
												<td><?php echo $i; ?></td>
												<td><a href="<?php echo base_url()?>/index.php/attendancepanel/employeewiseatt/<?php echo $employee->username;?>"><?php echo $employee->username;?></a></td>
