  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-white">
      <div class="panel-heading panel-red">
        <h4 class="panel-title">Welcome to <span class="text-bold">Exam Panel</span></h4>
          ...
          <a class="btn btn-xs btn-link panel-close" href="#">
            <i class="fa fa-times"></i>
									...
									<div class="panel-body">
										...
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/studentwiseexampanel">
										...
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/classwiseexampanel">
										...
										<!--<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/topperfomertotalexampanel">-->
										...
										<!--		</a>-->
										<!--	</div>-->
										<!--<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/topperfomersubjectexampanel">-->
										...
										<!--		</a>-->
										<!--	</div>-->
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/admitcardstudentexampanel">
                     ...
                     <div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/admitcardclassexampanel">
                       <!--<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/login/examTimeTable">-->
										...
										<!--<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/performancechartexampanel">-->
										<!--		<button class="btn panel-blue btn-icon btn-block space10">-->
										...
										<!--		</a>-->
										<!--	</div>-->
										<div class="col-sm-4"><a href="<?php echo base_url(); ?>index.php/exampanel/smsexampanel">
												<button class="btn panel-orange btn-icon btn-block space10">
