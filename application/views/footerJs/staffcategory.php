...
<script>
			...
			jQuery(document).ready(function() {
				$("#staff_id").keyup(function(){
					...
					//alert(staff_id);
					$.post("<?php echo site_url("index.php/employeeController/staff") ?>",{staff_id : staff_id}, function(data){
					$("#rahul").html(data);
						});
				});
				...
				$("#edit").click(function(){
					...
					// alert(uname);
					// alert(jobCategory);
					$.post("<?php echo site_url("index.php/employeeController/editstaff/") ?>",{jobCategory : jobCategory , uname : uname}, function(data){
					//alert(data);
					$("#edit").html(data);
