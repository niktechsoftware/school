<!-- start: MAIN JAVASCRIPTS -->
		...
		<script>
            ...
            $('#stock').DataTable();
								...
								var text_value = document.getElementById("itemName").value;
								value = text_value.replace(/[ ]+/g," ").replace(/[^(A-Za-z )]*/g, "");
								document.getElementById("itemName").value=value;
							     }
							     
							      function namevalidation1() {
								var text_value = document.getElementById("itemCat").value;
								value = text_value.replace(/[ ]+/g," ").replace(/[^(A-Za-z )]*/g, "");
								document.getElementById("itemCat").value=value;
							     }
                                 ...
                                 if (!text_value.match(/[0-9]$/))
                                 {
                                   ...
                                   {
                                 var text_value = document.getElementById("price").value;
                                 if (!text_value.match(/[0-9]$/))
                                 {
                                     document.getElementById("price1").innerHTML = "Invalid Item Price";
							         ...
							         function quantity()
                                  {
                                 var text_value = document.getElementById("itemQuantity").value;
                                 if (!text_value.match(/[0-9]$/))
                                 {
                                     document.getElementById("item").innerHTML = "Invalid Item Quantity";
