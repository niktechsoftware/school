<!-- start: MAIN JAVASCRIPTS -->
	...
	$.post("<?php echo site_url("index.php/examControllers/checkIDforadmin") ?>",{admin_id : admin_id,exam_id:exam_id}, function(data){
		$("#validId").html(data);
		 ...
		 $("#otp").keyup(function()
                      ...
                      $.post("<?php echo site_url('index.php/examControllers/deleteexambyotp') ?>",{mobile : mobile, otp : otp},
                   function(data)
                       {
                   $("#validId").html(data);
                  });
		          ...
		          $("#conform").click(function()
                          {
                         var exam_id = $("#exam_id").val();
                     $.post("<?php echo site_url('index.php/examControllers/Suceesotpdeleteexamby') ?>",{exam_id : exam_id},
                      function(data)
                     {
                       $("#validId").html(data);
                       $("#conform").hide();
