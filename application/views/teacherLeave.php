		...
		<div class="panel panel-white">
			<div class="panel-heading panel-orange">
				<h4 class="panel-title">
					Teacher <span class="text-bold">Leave Detail</span>
				</h4>
			...
			<div class="panel-body">
				<div class="alert alert-info">
					<h3 class="media-heading text-center">Welcome to Teacher Leave
						Detail Area,</h3>
					<p class="media-timestamp">Here you can see your leave details.If
						your leave is Approved then you will see Approved Button. You can
						also request for Leave by click on Define New Leave Button.</p>
				</div>
				<?php if($this->uri->segment("3")=="Success"){?>
				<div class = "alert alert-danger">
				Leave Details are Successfully Deleted!!!!!!!
				</div>
				<?php }?>
				<div class="form-group">
					<div class="col-sm-12">
						<div class="row">
							...
							<?php if($teacherLeave->num_rows()>0){?>
			...
			$count = 1;
			foreach ( $teacherLeave->result () as $lv ) :
				?>
			...
			<?php }else{?>
           <td><button type="submit" class="btn btn-yellow">Approved</button></td>
			...
			<?php } ?>
		  		...
		  		<?php $count++; endforeach; ?>
								...
								<?php }else{
									?>
															<div class = "alert alert-warning"><strong><h1>Leave Record Not Found!!!!!</h1></strong></div>
															
							<?php 	}?>
								<div>
									<div class="col-sm-2 col-sm-offset-8">
										<button type="submit" id="sonu"
											class="btn btn-green next-step btn-block">
									...
									<div id="stuLeave">
										<form
											action="<?php echo base_url();?>index.php/singleTeacherControllers/insertLeave"
											method="post">
											<div class="form-group">
												<div class="row">
													<div class="col-md-6">
