		...
		<script>
			...
			jQuery(document).ready(function() {
				...
				$("#sectionId").change(function(){
					...
					// 	});
					// }else{
						$('#classv').prop('disabled', false);
						$.post("<?php echo site_url("index.php/teacherController/getSectiontransport") ?>",{sectionid : sectionid}, function(data){
							$("#classv").html(data);
						});
					// }
				});
				$("#classv").change(function(){
					...
					$.post("<?php echo site_url("index.php/feeControllers/transReport") ?>",{fsd : fsd,classv : classv,section : section}, function(data){
						$("#rahul").html(data);
					});
				});
				Main.init();
