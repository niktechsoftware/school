		...
		<!-- end: CORE JAVASCRIPTS  -->
			...
			jQuery(document).ready(function() {
				...
				$("#edate").change(function(){
					...
					$.post("<?php echo site_url("index.php/singleStudentControllers/stuReport") ?>",{edate : edate,sdate : sdate}, function(data){
					$("#rahul").html(data);
						});
				});
			...
			var leaveid = $("#rowid").val();
		    //	alert(leaveid);
			$.post("<?php echo site_url("index.php/singleStudentControllers/deleteleave") ?>",{leaveid : leaveid}, function(data){
				$("#leavedelete").html(data);
			...
			$("#classv").change(function(){
				...
				$("#sectionId").change(function(){
					...
					//alert(classid);
					// $.ajax({
					// 	"url": "<?= base_url() ?>index.php/studentController/class_wise_icard",
					// 	"method": 'POST',
