<div class="col-md-12">
	<div class="panel">
		<div class="panel-heading panel-blue border-light">
			<h4 class="panel-title">Employee Salary Detail</h4>
		</div>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo base_url()?>employeeController/deleteSalaryReciept/<?php echo $row->salaryInvoice;?>" class="btn btn-danger">
								Delete Invoice
							</a>
						</td>
					</tr>	
