  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-white">
      <div class="panel-heading panel-red">
        <h4 class="panel-title">Studentwise <span class="text-bold">Timetable Report</span></h4>
				 ...
				 <div class="col-sm-12">
                      <div class="panel panel-calendar">
                        <div class="panel-heading panel-blue border-light">
                          <h4 class="panel-title">Student Timetable list</h4>
                        </div>
                        <div class="panel-body" id="timetablelist">
