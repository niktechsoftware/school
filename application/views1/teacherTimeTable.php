...
<div class="alert alert-info"><h3 class="media-heading text-center">welcome to the exam time table</h3><p class="media-timestamp">In this section you see the exam time table/ schedule of every class/ shift. if you want see the list than you select subject on select exam name field and show all exam date or time of this subject. if you want any change on time delete any field, you can done it by using edit or delete button.</div>
										<div class="row">
