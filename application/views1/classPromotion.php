		...
		<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
								  <div class="panel-heading panel-purple">
										...
										<h4 class="panel-title">Student  <span class="text-bold">Promote Section</span></h4>
          ...
          <h3 class="media-heading text-center">Welcome to Student Promotion Area </h3> Here you can Promote a student to One Class to next Class before Promote ensure that Student passout current Class.
		   Please Select Stream , Section and Class then Press Promote Button for Promote a single Student of Class .
        </div>
									<div class="row">
