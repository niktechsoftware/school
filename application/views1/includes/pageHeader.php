...
<div class="row">
    <div class="col-md-12">
        ...
        <a class="btn btn-grey" style="margin-bottom:3px;" href="<?php echo base_url(); ?>index.php/smsAjax/smsPanel">SMS Panel</a>
        <a class="btn btn-orange" style="margin-bottom:3px;" href="<?php echo base_url(); ?>index.php/studentController/studentPanel">Student Panel</a>
        <a style="margin-bottom:3px;" class="btn btn-green" href="<?php echo base_url(); ?>index.php/exampanel">Exam Detail</a>
        <a  style="margin-bottom:3px;" class="btn btn-purple" href="<?php echo base_url(); ?>index.php/attendancepanel">Attendance Report</a>
        <a style="margin-bottom:3px;" class="btn btn-dark-beige" href="<?php echo base_url(); ?>index.php/feepanel">Fee Report</a>
        <a style="margin-bottom:3px;" class="btn btn-dark-azure" href="<?php echo base_url(); ?>index.php/homeworkpanel">Home Work</a>
        <a style="margin-bottom:3px;" class="btn btn-dark-yellow" href="<?php echo base_url(); ?>index.php/timetablepanel">Time Table</a>
        <!--<a  style="margin-bottom:3px;" class="btn btn-dark-green" href="<?php echo base_url(); ?>index.php/vreportpanel"> Varification Report</a>-->
        <a  style="margin-bottom:3px;" class="btn btn-dark-purple" href="<?php echo base_url(); ?>index.php/login/newAdmission">Student Registration</a>
