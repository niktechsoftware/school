			...
			<div class="panel-body">
				...
				<div class="table-responsive">
					...
					?>
		                ...
		                <?php 
		                $sno = 1;
		                	foreach($this->db->query("SELECT * FROM bank_transaction WHERE id_name='receive' AND school_code='$school_code'")->result() as $row):
		                	?>
		                	<tr>
		                    	<td><?php echo $sno; ?></td>
		                        <td><?php echo $row->id_name; ?></td>
					...
					?>
		                ...
		                <?php 
		                $sno = 1;
		                	foreach($this->db->query("SELECT * FROM director_transaction WHERE action='Diposited' AND school_code='$school_code'")->result() as $row):
		                	?>
		                	<tr>
		                    	<td><?php echo $sno; ?></td>
					...
					?>
		                ...
		                <?php 
		                $sno = 1;
		                	foreach($this->db->query("SELECT * FROM director_transaction WHERE action='Receive' AND school_code='$school_code'")->result() as $row):
		                	?>
		                	<tr>
		                    	<td><?php echo $sno; ?></td>
		                        <td><?php echo $row->action; ?></td>
